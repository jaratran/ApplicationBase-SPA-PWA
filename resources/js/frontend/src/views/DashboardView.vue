      ...
      <div class="card-body">
        <div class="card mb-4">
          <div
            ...
            Consolidado Semanal, desde el <strong>{{ panel.desdeFecha }}</strong> al <strong>{{ panel.hastaFecha
              }}</strong>
          </div>
        ...
        <!-- Programa Diario -->
        <div class="card">
          <div class="card-header bg-secondary text-white fs-5 d-flex justify-content-between align-items-center flex-wrap">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-stretch">
              <div class="col-span-12 md:col-span-8">
                Programa Diario vigente el día de HOY : <strong>{{ panel.fecha_vigente_programa }}</strong><br />
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-striped table-bordered table-hover align-middle text-center shadow-sm">
                <thead>
                  <tr>
                    <th>Estado</th>
                    <th>Novedad</th>
